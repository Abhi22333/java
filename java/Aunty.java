...
{
String kgf ="yash";
String kaatera=" darshan";
System.out.println(kgf+ "  "+kaatera);
System.out.println(kgf);
System.out.println(kaatera) ;
boolean system=true;
...
int hardikpandiya=5;
System.out.println("hardikpandiya:"+hardikpandiya);
...
public static void southAfrica()
{
	...
	System.out.println("quintonDeKock:"+quintonDeKock);	
	int aidenMarkram=4;
	...
	System.out.println("davidmiller:"+davidmiller);
     int marcojanson=2;
System.out.println("marcojanson:"+marcojanson);		 
int keshavMaharaj=2;
