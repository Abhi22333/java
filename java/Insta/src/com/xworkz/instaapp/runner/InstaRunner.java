package com.xworkz.instaapp.runner;
...
import com.xworkz.instaapp.constants.Instaconnection;
import com.xworkz.instaapp.query.InstaInsertQuery;
import com.xworkz.instaapp.readoperations.*;
...
public class InstaRunner {
	...
	public static void main(String[] args) {
		...
		try {
			connection = DriverManager.getConnection(Instaconnection.URL.getValue(),
					Instaconnection.USERNAME.getValue(), Instaconnection.PASSWORD.getValue());
